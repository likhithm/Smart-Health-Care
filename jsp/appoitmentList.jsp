...
<%List<AppoitmentList> appoitmentLists=new ArrayList();

appoitmentLists=(List<AppoitmentList>)session.getAttribute("appoitmentList"); %>
...
<div id="wrapper">
    ...
    <section id="Appoitment" class="intro">
       ...
       <th>PhysicianId &nbsp;&nbsp;</th><th>AppoitmentDate &nbsp;&nbsp;</th><th>AppoitmentTime &nbsp;&nbsp;</th>  <th>PatientId &nbsp;&nbsp;</th>
        <tbody>
      <%
        for(AppoitmentList appoitmentList:appoitmentLists)
            {%>
        	<tr>
            <td><%=appoitmentList.getPhysicianId()%> &nbsp;&nbsp;</td><td><%=appoitmentList.getAppoitmentDate()%> &nbsp;&nbsp;</td><td><%=appoitmentList.getAppoitmentTime()%> &nbsp;&nbsp;</td>  <td><%=appoitmentList.getPatientId()%> &nbsp;&nbsp;</td>
