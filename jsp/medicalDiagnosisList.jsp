...
<body  id="page-top" data-spy="scroll" data-target=".navbar-custom"  onload="Alert.render('MEDICAL DIAGNOSIS LIST.')">
...
<div id="wrapper">
    ...
    <section id="MedicalAdvice" class="intro">
       ...
       <th>Patient_ID &nbsp;&nbsp;</th><th>Symptoms &nbsp;&nbsp;</th><th>Previous_Medicines &nbsp;&nbsp;</th>  <th>Current_Prescribed_Medicine&nbsp;&nbsp;</th><th>Physician_ID &nbsp;&nbsp;</th><th>Diagnosis_Date &nbsp;&nbsp;</th> <th>Dosage&nbsp;&nbsp;</th> <th>Time-of-day &nbsp;&nbsp;</th> <th>Pharmacy_ID &nbsp;&nbsp;</th>
        <tbody>
      <%
        for(MedicalDiagnosisTO appoitmentList:appoitmentLists)
            {%>
        	<tr>
            <td><b><%=appoitmentList.getPatientID()%></b></td><td><%=appoitmentList.getSymptoms()%> &nbsp;&nbsp;</td><td><%=appoitmentList.getPreviousMedicines()%> &nbsp;&nbsp;</td><td><%=appoitmentList.getMedicalDiagnosis()%> &nbsp;&nbsp;</td>  <td><%=appoitmentList.getPhysicianId()%> &nbsp;&nbsp;</td><td><%=appoitmentList.getDiagnosisDate()%> &nbsp;&nbsp;</td> <td><b><%=appoitmentList.getDosage()%></b></td><td><b><%=appoitmentList.getTimeOfDay()%></b></td><td><b><%=appoitmentList.getPharmacistId()%></b></td>
...
<br><br><br><br><br><br><br><br><br><br><br><br>	
	...
	<!-- Section: team -->
    <section id="getappointment" class="home-section bg-gray paddingbot-60" style="background: wheat">
