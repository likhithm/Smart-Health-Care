...
<body  id="page-top" data-spy="scroll" data-target=".navbar-custom"  onload="Alert.render('Pharmacist Login Success!!')">
							...
							<div class="panel panel-skin">
									<div class="panel-body">
    					                <form action="./pharmacy" method="post" role="form" class="contactForm lead">
    										...
    										<input type="submit" value="ToDayPharmacy" class="btn btn-skin btn-block">
    												</div>
    											</div>
